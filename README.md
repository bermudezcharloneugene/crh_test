...
## NOTES 
    ...
    I use laravel passport for api authentication and vue js for my single page application. I was hoping to use vuex and vue guards for my routes but I didn't have the luxury of time to do it. I manage to create an auth page that gets and api token and store it to the browser's local storage and check weather theres an api token existing or not. It has a lot of bugs specially when you try to refresh the page since I dont have the guards to check it. 
